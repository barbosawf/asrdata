...
library(nadiv)
pedigree <- read.table("Material/GS/AHAT/Pedigree.txt", h = TRUE)
head(pedigree)
...
dim(M_filter$M.clean) # 247 x 2776
...
GD <- G.matrix(M = M_filter$M.clean,
               method = 'Su',
               na.string = NA)$G
GD[1:5, 1:5]
